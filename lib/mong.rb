...
module Mong
  ...
  def self.parse_minute(string)
    ...
    return false if index < 0 || index >= 60
  ...
  def self.parse_hour(string)
    ...
    return false if index < 0 || index >= 24
  ...
  def self.parse_hour_and_minute(string)
    ...
    hour_out = self.parse_hour(hour)
    minute_out = self.parse_minute(minute)
  ...
  def self.parse(time)
    ...
    self.parse_hour_and_minute(string)
  end
end
